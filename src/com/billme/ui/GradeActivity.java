...
public class GradeActivity extends BaseActivity implements BillMeActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list = (ListView) findViewById(R.id.lv_grade_list);
		if (this.pd == null) {
		...
		Task task = new Task(Task.TASK_GET_EXCHANGE_LIST);
