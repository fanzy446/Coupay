/**
 * @file TradingRecordListViewHeader.java
 * @create Apr 18, 2012 5:22:27 PM
 * @author Maxwin
 * @description TradingRecordListView's header
 */
...
public class TradingRecordListViewHeader extends LinearLayout {
	...
	public TradingRecordListViewHeader(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param attrs
	 */
	public TradingRecordListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		mContainer = (RelativeLayout) LayoutInflater.from(context).inflate(
				R.layout.trading_record_listview_header, null);
