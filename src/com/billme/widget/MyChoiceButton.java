...
public class MyChoiceButton extends LinearLayout implements View.OnTouchListener
{
...
//	}
	...
	public boolean onTouch(View v, MotionEvent event)
	{
		...
		switch(v.getId())
		{
		case R.id.ib_mychoicebutton_image0:index = 0;imgSource=R.drawable.pay_on;break;
		case R.id.ib_mychoicebutton_image1:index = 1;imgSource=R.drawable.society_on;break;
		case R.id.ib_mychoicebutton_image2:index = 2;imgSource=R.drawable.code_on;break;
		case R.id.ib_mychoicebutton_image3:index = 3;imgSource=R.drawable.management_on;break;
		default:break;
		}
...
//	};
	...
	public void showChoice(MotionEvent event)
	{
		...
		currentY = (int) event.getY() - statusBarHeight - this.getLayoutHeight() / 2;
	...
	private int inWitchRect(MotionEvent event, int m)
	{
		...
		if (touchX >= tempX - m * this.getWidth() / 2
				&& touchX < tempX
				&& touchY >= tempY - m * this.getHeight() / 2
				&& touchY < tempY)
		{
			// 在第一块区域
			n = 0;
		}
		else if (touchX < tempX + m * this.getWidth() / 2
				&& touchX >= tempX
				&& touchY >= tempY - m * this.getHeight() / 2
				&& touchY < tempY)
		{
