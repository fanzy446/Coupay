...
public class AES {
	...
	private static void initialize() {
		byte[][] box1 = {
				...
				{ 4, -57, 35, -61, 24, -106, 5, -102, 7, 18, -128, -30, -21,
						39, -78, 117 },
				{ 9, -125, 44, 26, 27, 110, 90, -96, 82, 59, -42, -77, 41, -29,
						47, -124 },
				{ 83, -47, 0, -19, 32, -4, -79, 91, 106, -53, -66, 57, 74, 76,
						88, -49 },
				{ -48, -17, -86, -5, 67, 77, 51, -123, 69, -7, 2, 127, 80, 60,
						-97, -88 },
				{ 81, -93, 64, -113, -110, -99, 56, -11, -68, -74, -38, 33, 16,
						-1, -13, -46 },
				{ -51, 12, 19, -20, 95, -105, 68, 23, -60, -89, 126, 61, 100,
						93, 25, 115 },
				{ 96, -127, 79, -36, 34, 42, -112, -120, 70, -18, -72, 20, -34,
						94, 11, -37 },
		...
		byte[][] box2 = {
				...
				{ 96, 81, 127, -87, 25, -75, 74, 13, 45, -27, 122, -97, -109,
						-55, -100, -17 },
				{ -96, -32, 59, 77, -82, 42, -11, -80, -56, -21, -69, 60, -125,
						83, -103, 97 },
				{ 23, 43, 4, 126, -70, 119, -42, 38, -31, 105, 20, 99, 85, 33,
						12, 125 } };
	...
	private static void mixColumns() {
		...
		for (int c = 0; c < Nb; c++) {
			state[0][c] = (byte) (gfmutby02(temp[0][c]) ^ gfmutby03(temp[1][c])
					^ gfmutby01(temp[2][c]) ^ gfmutby01(temp[3][c]));
			...
			state[3][c] = (byte) (gfmutby03(temp[0][c]) ^ gfmutby01(temp[1][c]) ^ (gfmutby01(temp[2][c]) ^ gfmutby02(temp[3][c])));
	...
	private static void invMixColumns() {
		...
		for (int c = 0; c < Nb; c++) {
			state[0][c] = (byte) (gfmutby0e(temp[0][c]) ^ gfmutby0b(temp[1][c])
					^ gfmutby0d(temp[2][c]) ^ gfmutby09(temp[3][c]));

			state[1][c] = (byte) (gfmutby09(temp[0][c]) ^ gfmutby0e(temp[1][c])
					^ gfmutby0b(temp[2][c]) ^ gfmutby0d(temp[3][c]));

			state[2][c] = (byte) (gfmutby0d(temp[0][c]) ^ (gfmutby09(temp[1][c])
					^ gfmutby0e(temp[2][c]) ^ gfmutby0b(temp[3][c])));

			state[3][c] = (byte) (gfmutby0b(temp[0][c]) ^ gfmutby0d(temp[1][c]) ^ (gfmutby09(temp[2][c]) ^ gfmutby0e(temp[3][c])));
		}
	}
