...
public class ServiceType {
	...
	public static int LOGOUT = -201;
	public static int REGIST = -202;
	public static int CHECK_USER_EXISTENCE = -203;
	public static int PERSONAL_PAY = -204;
	public static int MUTIPLE_PAY = -205;
	...
	public static int GET_COMMENT = -224;
	...
	public static int GET_SURROUNDIND_ENTERPRISE = -229;
	...
	public static int QUERY_ENTERPRISE = -235;
	public static int QUERY_AVAILABLE_COUPON = -236;
}
